            ...
            "sections": [
                {
                    ...
                    "fields": [
                        {"key": "ho_ten", "label": "Họ và tên người được phỏng vấn",
                            "type": "text", "required": True},
                        {"key": "nam_sinh", "label": "Năm sinh", "type": "number"},
                        {"key": "so_dien_thoai",
                            "label": "Số điện thoại liên hệ", "type": "text"},
                    ...
                    "fields": [
                        {
                            ...
                            "columns": [
                                {"key": "ten_phu_pham", "label": "Tên phụ phẩm cây trồng",
                                    "type": "text", "required": True},
                                {"key": "thoi_diem_ap_dung_dau",
                                    "label": "Tháng/năm áp dụng kỹ thuật lần đầu", "type": "text"},
                                {"key": "dien_tich_trong",
                                    "label": "Diện tích trồng (sào/vụ)", "type": "number"},
                                {"key": "so_lan_len_men",
                                    "label": "Tổng số lần đã tiến hành", "type": "number"},
                                {"key": "thoi_diem_gan_nhat",
                                    "label": "Thời điểm lứa lên men gần nhất (tháng/năm)", "type": "text"},
                                {"key": "dien_tich_thu_gom",
                                    "label": "Diện tích phụ phẩm thu gom (sào)", "type": "number"},
                                {"key": "khoi_luong_thu_gom",
                                    "label": "Khối lượng phụ phẩm thu gom (kg)", "type": "number"},
                                {"key": "khoi_luong_u",
                                    "label": "Khối lượng phụ phẩm dùng ủ (kg)", "type": "number"},
                                {"key": "co_may_bam", "label": "Sử dụng máy băm/cắt",
                                    "type": "select", "options": ["Có", "Không"]},
                                {"key": "nhien_lieu",
                                    "label": "Nhiên liệu đã dùng (dầu/điện)", "type": "text"},
                                {"key": "chi_phi_khac",
                                    "label": "Chi phí vật liệu/đầu vào khác (đồng)", "type": "number"},
                            ],
                        }
                    ],
                },
                    ...
                    "fields": [
                        {
                            ...
                            "columns": [
                                {"key": "loai_cay_trong", "label": "Loại cây trồng",
                                    "type": "text", "required": True},
                                {
                                    "key": "co_ap_dung",
                                ...
                                {"key": "dien_tich",
                                    "label": "Diện tích (sào/vụ x số vụ/năm)", "type": "text"},
                                {"key": "loai_phu_pham",
                                    "label": "Loại phụ phẩm", "type": "text"},
                                {"key": "khoi_luong_phu_pham",
                                    "label": "KG phụ phẩm thu gom (kg/sào/vụ)", "type": "number"},
                                {"key": "khoi_luong_su_dung",
                                    "label": "KG phụ phẩm được dùng ủ (kg/sào/vụ)", "type": "number"},
                            ],
                        }
                    ],
                },
                    ...
                    "fields": [
                        {
                            ...
                            "columns": [
                                {"key": "ten_vat_nuoi", "label": "Tên vật nuôi",
                                    "type": "text", "required": True},
                                {"key": "tong_so_lua",
                                    "label": "Số lứa đã nuôi bằng thức ăn ủ", "type": "number"},
                                {"key": "thuc_an_sau",
                                    "label": "Các loại thức ăn (SAU khi dùng thức ăn ủ)", "type": "text"},
                                {"key": "chi_phi_sau",
                                    "label": "Số tiền mua thức ăn/lứa (sau)", "type": "number"},
                                {"key": "suc_khoe_sau",
                                    "label": "Đánh giá sức khỏe (1-10) sau khi dùng", "type": "number"},
                                {"key": "thoi_gian_xuat_sau",
                                    "label": "Thời gian & trọng lượng xuất chuồng (sau)", "type": "text"},
                                {"key": "thuc_an_truoc",
                                    "label": "Các loại thức ăn (TRƯỚC khi dùng thức ăn ủ)", "type": "text"},
                                {"key": "chi_phi_truoc",
                                    "label": "Số tiền mua thức ăn/lứa (trước)", "type": "number"},
                                {"key": "suc_khoe_truoc",
                                    "label": "Đánh giá sức khỏe (1-10) trước khi dùng", "type": "number"},
                                {"key": "thoi_gian_xuat_truoc",
                                    "label": "Thời gian & trọng lượng xuất chuồng (trước)", "type": "text"},
                            ],
                        }
                    ],
                },
        ...
        "schema": {
            "sections": [
                    ...
                    "fields": [
                        {
                            ...
                            "columns": [
                                {"key": "phuong_phap", "label": "Phương pháp",
                                    "type": "text", "required": True},
                                {"key": "truoc_tham_gia",
                                    "label": "Trước khi tham gia (%)", "type": "number"},
                                {"key": "sau_tham_gia",
                                    "label": "Sau khi tham gia (%)", "type": "number"},
                            ],
                            "preset_rows": [
                        ...
                        {"key": "co_chan_nuoi", "label": "Gia đình có nuôi động vật?",
                            "type": "select", "options": ["Có", "Không"]},
                        {
                            "type": "table",
                    ...
                    "fields": [
                        {
                            ...
                            "columns": [
                                {"key": "ten_ky_thuat", "label": "Kỹ thuật",
                                    "type": "text", "required": True},
                                {"key": "do_kho",
                                    "label": "Dễ/khó (1-10)", "type": "number"},
                                {"key": "loi_nhuan",
                                    "label": "Tăng lợi nhuận", "type": "number"},
                                {"key": "giam_chi_phi",
                                    "label": "Giảm chi phí", "type": "number"},
                                {"key": "giam_cong_viec",
                                    "label": "Giảm khối lượng công việc", "type": "number"},
                                {"key": "tot_cho_moi_truong",
                                    "label": "Tốt cho môi trường", "type": "number"},
                                {"key": "cai_thien_dat",
                                    "label": "Cải thiện chất lượng đất", "type": "number"},
                            ],
                            "preset_rows": [
                    ...
                    "fields": [
                        {
                            ...
                            "columns": [
                                {"key": "hoat_dong", "label": "Hoạt động",
                                    "type": "text", "required": True},
                                {"key": "da_nghe", "label": "Đã nghe nói",
                                    "type": "select", "options": ["Đúng", "Không"]},
                                {"key": "da_tham_du", "label": "Đã tham dự",
                                    "type": "select", "options": ["Đúng", "Không"]},
                                {"key": "anh_huong",
                                    "label": "Mức ảnh hưởng (1-5)", "type": "number"},
                            ],
                            "preset_rows": [
                        ...
                        {"key": "su_kien_muon_tham_gia",
                            "label": "Bạn sẽ tham gia sự kiện nào?", "type": "text"},
                        {"key": "ly_do_khong_tham_gia",
                            "label": "Nếu không tham gia, lý do là gì?", "type": "text"},
                        {
                            "type": "table",
                            ...
                            "columns": [
                                {"key": "kenh", "label": "Kênh truyền thông",
                                    "type": "text", "required": True},
                                {"key": "da_tiep_can", "label": "Đã nghe/nhìn thấy",
                                    "type": "select", "options": ["Đúng", "Không"]},
                                {"key": "anh_huong",
                                    "label": "Mức ảnh hưởng (1-5)", "type": "number"},
                            ],
                ...
                },
                {
                    ...
                    "fields": [
                        {"key": "thu_nhap_2025",
                            "label": "Ước tính thu nhập trung bình 2025 (đồng/tháng)", "type": "number"},
                        {"key": "nguon_thu_nhap", "label": "Nguồn thu nhập chính", "type": "multi_select", "options": [
                            "Trồng trọt", "Chăn nuôi", "Công ty", "Doanh nghiệp", "Khác"]},
                        {
                        ...
                        {"key": "tham_gia_xanh", "label": "Biết/ tham gia nhóm Người gìn giữ tương lai xanh",
                            "type": "select", "options": ["Thuộc nhóm", "Đã nghe", "Không biết"]},
                        {"key": "muon_tham_gia_xanh", "label": "Có muốn tham gia nhóm Người gìn giữ tương lai xanh?",
                            "type": "select", "options": ["Có", "Không"]},
                    ],
                },
            ]
                    ...
                    "fields": [
                        {
                            ...
                            "columns": [
                                ...
                                {"key": "thoi_diem_bat_dau",
                                    "label": "Tháng/năm bắt đầu tận dụng phụ phẩm", "type": "text"},
                                {"key": "tong_mua_vu",
                                    "label": "Tổng số mùa vụ đã tận dụng", "type": "number"},
                                {"key": "dien_tich_trong",
                                    "label": "Diện tích trồng (sào/vụ)", "type": "number"},
                                {"key": "thoi_diem_lam_dem",
                                    "label": "Thời điểm làm đệm gần nhất", "type": "text"},
                                {"key": "dien_tich_su_dung",
                                    "label": "Diện tích dùng làm đệm (sào)", "type": "number"},
                                {"key": "khoi_luong_tao_ra",
                                    "label": "Khối lượng phụ phẩm tạo ra (kg/sào)", "type": "number"},
                                {"key": "khoi_luong_thu_gom",
                                    "label": "Khối lượng phụ phẩm thu gom (kg)", "type": "number"},
                                {"key": "khoi_luong_lam_dem",
                                    "label": "Khối lượng dùng làm đệm (kg)", "type": "number"},
                                {"key": "co_may_bam", "label": "Sử dụng máy băm/cắt",
                                    "type": "select", "options": ["Có", "Không"]},
                                {"key": "nhien_lieu",
                                    "label": "Nhiên liệu đã sử dụng", "type": "text"},
                                {"key": "chi_phi_khac",
                                    "label": "Chi phí vật liệu/đầu vào khác (đồng)", "type": "number"},
                            ],
                        }
                    ...
                    "fields": [
                        {
                            ...
                            "columns": [
                                ...
                                {"key": "loai_phu_pham",
                                    "label": "Loại phụ phẩm", "type": "text"},
                                {"key": "kg_phu_pham",
                                    "label": "KG phụ phẩm tại ruộng (kg/sào/vụ)", "type": "number"},
                                {"key": "kg_thu_gom",
                                    "label": "KG phụ phẩm thu gom (kg/sào/vụ)", "type": "number"},
                            ],
                        }
                    ...
                    "fields": [
                        {
                            ...
                            "columns": [
                                {"key": "ten_cay_trong", "label": "Tên cây trồng",
                                    "type": "text", "required": True},
                                {"key": "dien_tich",
                                    "label": "Diện tích (sào)", "type": "number"},
                                {"key": "phan_su_dung",
                                    "label": "Tên/khối lượng từng loại phân bón", "type": "text"},
                                {"key": "chi_phi_phan",
                                    "label": "Chi phí mua phân (đồng)", "type": "number"},
                                {"key": "so_lan_phun_thuoc",
                                    "label": "Số lần phun thuốc trừ sâu/cỏ", "type": "number"},
                                {"key": "chi_phi_thuoc",
                                    "label": "Chi phí thuốc (đồng)", "type": "number"},
                                {"key": "chi_phi_cong",
                                    "label": "Chi phí công lao động (đồng)", "type": "number"},
                                {"key": "sau_benh", "label": "Cây bị sâu bệnh?",
                                    "type": "select", "options": ["Có", "Không"]},
                                {"key": "nang_suat",
                                    "label": "Năng suất thu hoạch (kg/sào)", "type": "number"},
                                {"key": "gia_ban",
                                    "label": "Giá bán (đồng/kg)", "type": "number"},
                                {"key": "thanh_tien",
                                    "label": "Thành tiền (đồng)", "type": "number"},
                            ],
                        }
                    ],
                },
                    ...
                    "fields": [
                        {
                            ...
                            "columns": [
                                {"key": "thoi_diem", "label": "Thời điểm lứa nuôi",
                                    "type": "text", "required": True},
                                {"key": "so_luong",
                                    "label": "Số lượng gà trong đợt (con)", "type": "number"},
                                {"key": "thuc_an",
                                    "label": "Thức ăn cho lứa nuôi", "type": "text"},
                                {"key": "chi_phi_thuc_an",
                                    "label": "Chi phí thức ăn (đồng)", "type": "number"},
                                {"key": "chi_phi_thuoc",
                                    "label": "Chi phí thuốc thú y (đồng)", "type": "number"},
                                {"key": "cong_don_dep",
                                    "label": "Số giờ dọn dẹp mỗi tuần", "type": "number"},
                                {"key": "benh", "label": "Đàn gà có mắc bệnh không",
                                    "type": "select", "options": ["Có", "Không"]},
                                {"key": "suc_khoe",
                                    "label": "Đánh giá sức khỏe đàn gà (1-10)", "type": "number"},
                                {"key": "ngay_dat_trong_luong",
                                    "label": "Số ngày đạt trọng lượng", "type": "number"},
                                {"key": "trong_luong_tb",
                                    "label": "Trọng lượng TB khi xuất chuồng (kg/con)", "type": "number"},
                                {"key": "tong_thoi_gian_nuoi",
                                    "label": "Tổng thời gian nuôi đến xuất chuồng (tháng)", "type": "number"},
                                {"key": "gia_ban",
                                    "label": "Giá bán (đồng/kg)", "type": "number"},
                                {"key": "thu_nhap",
                                    "label": "Tổng thu nhập (đồng)", "type": "number"},
                                {"key": "muc_do_mui",
                                    "label": "Đánh giá mùi chuồng gà (0-10)", "type": "number"},
                            ],
                        }
                    ],
                },
            ...
            "sections": [
                {
                    ...
                    "fields": [
                        {"key": "ngay_bat_dau",
                            "label": "Tháng/năm bắt đầu nuôi", "type": "text"},
                        {"key": "so_lua_da_nuoi",
                            "label": "Số lứa sâu đã nuôi", "type": "number"},
                        {"key": "so_ngay_mot_lua",
                            "label": "Số ngày cho một lứa (TB 45 ngày)", "type": "number"},
                        {"key": "chi_phi_xay_dung",
                            "label": "Tổng chi phí xây dựng khu nuôi (đồng)", "type": "number"},
                        {"key": "chi_phi_giong",
                            "label": "Chi phí mua giống sâu (trứng)", "type": "number"},
                        {"key": "chi_phi_khac",
                            "label": "Chi phí đầu vào/vật liệu khác", "type": "number"},
                        {
                        ...
                        },
                        {
                            ...
                            "columns": [
                                {"key": "ten_loai", "label": "Tên loài vật nuôi",
                                    "type": "text", "required": True},
                                {"key": "so_con", "label": "Số lượng con/lứa",
                                    "type": "number"},
                                {"key": "so_lua_duoc_cho_an",
                                    "label": "Số lứa được cho ăn sâu", "type": "number"},
                            ],
                        },
                        {
                            "type": "table",
                            ...
                            "columns": [
                                {"key": "ten_cay_trong", "label": "Tên cây trồng",
                                    "type": "text", "required": True},
                                {"key": "so_vu", "label": "Tổng số vụ bón",
                                    "type": "number"},
                                {"key": "dien_tich",
                                    "label": "Diện tích (sào/vụ)", "type": "number"},
                            ],
                        },
                    ],
                },
                    ...
                    "fields": [
                        {
                            ...
                            "columns": [
                                {"key": "loai_phu_pham", "label": "Loại phụ phẩm nông nghiệp",
                                    "type": "text", "required": True},
                                {"key": "khoi_luong_ngay",
                                    "label": "Khối lượng phụ phẩm/ngày", "type": "number"},
                                {"key": "so_luong_vat_nuoi_thai",
                                    "label": "Số lượng vật nuôi tạo phân thải", "type": "number"},
                                {"key": "so_ngay_lua",
                                    "label": "Số ngày/lứa nuôi", "type": "number"},
                                {"key": "so_lua", "label": "Số lứa nuôi bằng phụ phẩm này",
                                    "type": "number"},
                                {"key": "tong_khoi_luong",
                                    "label": "Tổng khối lượng phụ phẩm tạo ra (kg)", "type": "number"},
                                {"key": "phu_pham_dung_cho_sau",
                                    "label": "Khối lượng dùng cho sâu (kg/ngày)", "type": "number"},
                                {"key": "ty_le_su_dung",
                                    "label": "Tỷ lệ % phụ phẩm dùng cho sâu", "type": "number"},
                                {"key": "dien_tich_nuoi",
                                    "label": "Diện tích nuôi sâu (m2/lứa)", "type": "number"},
                                {"key": "chi_phi_giong",
                                    "label": "Chi phí mua giống (đồng)", "type": "number"},
                                {"key": "so_ngay_thu_hoach",
                                    "label": "Số ngày để thu hoạch một lứa", "type": "number"},
                                {"key": "khoi_luong_sau",
                                    "label": "Khối lượng sâu thu được (kg/lứa)", "type": "number"},
                                {"key": "khoi_luong_phan",
                                    "label": "Khối lượng phân sâu thu được (kg/lứa)", "type": "number"},
                                {"key": "cong_lao_dong",
                                    "label": "Công lao động (giờ/ngày)", "type": "number"},
                            ],
                        }
                    ],
                },
                    ...
                    "fields": [
                        {
                            ...
                            "columns": [
                                {"key": "ten_cay_trong", "label": "Tên cây trồng",
                                    "type": "text", "required": True},
                                {"key": "thoi_gian_trong",
                                    "label": "Thời gian trồng (tháng/năm)", "type": "text"},
                                {"key": "dien_tich",
                                    "label": "Diện tích (sào/vụ)", "type": "number"},
                                {"key": "phan_su_dung",
                                    "label": "Khối lượng từng loại phân bón", "type": "text"},
                                {"key": "chi_phi_phan",
                                    "label": "Chi phí mua phân (đồng)", "type": "number"},
                                {"key": "so_lan_phun_thuoc",
                                    "label": "Số lần phun thuốc trừ sâu/cỏ", "type": "number"},
                                {"key": "chi_phi_thuoc",
                                    "label": "Chi phí thuốc (đồng)", "type": "number"},
                                {"key": "chi_phi_cong",
                                    "label": "Chi phí chăm sóc/nhân công (đồng)", "type": "number"},
                                {"key": "sau_benh", "label": "Cây bị sâu bệnh?",
                                    "type": "select", "options": ["Có", "Không"]},
                                {"key": "nang_suat",
                                    "label": "Năng suất thu hoạch (kg/sào)", "type": "number"},
            ...
            "sections": [
                {
                    ...
                    "fields": [
                        {"key": "ngay_bat_dau",
                            "label": "Tháng/năm bắt đầu nuôi", "type": "text"},
                        {"key": "so_lua_da_nuoi",
                            "label": "Số lứa trùn đã nuôi", "type": "number"},
                        {"key": "so_ngay_mot_lua",
                            "label": "Số ngày cho một lứa (TB 60 ngày)", "type": "number"},
                        {"key": "chi_phi_xay_dung",
                            "label": "Tổng chi phí xây dựng khu nuôi (đồng)", "type": "number"},
                        {"key": "chi_phi_giong",
                            "label": "Chi phí mua sinh khối trùn giống", "type": "number"},
                        {"key": "chi_phi_khac",
                            "label": "Chi phí đầu vào/vật liệu khác", "type": "number"},
                        {
                        ...
                        },
                        {
                            ...
                            "columns": [
                                ...
                                {"key": "so_con", "label": "Số lượng con/lứa",
                                    "type": "number"},
                                {"key": "so_lua_duoc_cho_an",
                                    "label": "Số lứa được cho ăn trùn", "type": "number"},
                            ],
                        },
                        {
                            "type": "table",
                    ...
                    "fields": [
                        {
                            ...
                            "columns": [
                                ...
                                {"key": "tong_khoi_luong",
                                    "label": "Tổng khối lượng phụ phẩm tạo ra (kg)", "type": "number"},
                                {"key": "phu_pham_dung_cho_trun",
                                    "label": "Khối lượng dùng cho trùn (kg/ngày)", "type": "number"},
                                {"key": "ty_le_su_dung",
                                    "label": "Tỷ lệ % phụ phẩm dùng cho trùn", "type": "number"},
                                {"key": "dien_tich_nuoi",
                                    "label": "Diện tích nuôi trùn (m2/lứa)", "type": "number"},
                                {"key": "chi_phi_giong",
                                    "label": "Chi phí mua giống (đồng)", "type": "number"},
                                {"key": "so_ngay_thu_hoach",
                                    "label": "Số ngày để thu hoạch một lứa", "type": "number"},
                                {"key": "khoi_luong_trun",
                                    "label": "Khối lượng trùn thu được (kg/lứa)", "type": "number"},
                                {"key": "khoi_luong_phan",
                                    "label": "Khối lượng phân trùn thu được (kg/lứa)", "type": "number"},
                                {"key": "cong_lao_dong",
                                    "label": "Công lao động (giờ/ngày)", "type": "number"},
                            ],
                        }
                    ...
                    "fields": [
                        {
                            ...
                            "columns": [
                                {"key": "ten_vat_nuoi", "label": "Loại vật nuôi",
                                    "type": "text", "required": True},
                                {"key": "so_con", "label": "Số con/lứa",
                                    "type": "number"},
                                {"key": "thuc_an_sau",
                                    "label": "Thức ăn (sau khi dùng trùn)", "type": "text"},
                                {"key": "chi_phi_sau",
                                    "label": "Chi phí thức ăn (sau) (đồng)", "type": "number"},
                                {"key": "suc_khoe_sau",
                                    "label": "Đánh giá sức khỏe (1-10) sau", "type": "number"},
                                {"key": "thoi_gian_xuat_sau",
                                    "label": "Thời gian & trọng lượng xuất chuồng (sau)", "type": "text"},
                                {"key": "thuc_an_truoc",
                                    "label": "Thức ăn (trước khi dùng trùn)", "type": "text"},
                                {"key": "chi_phi_truoc",
                                    "label": "Chi phí thức ăn (trước) (đồng)", "type": "number"},
                                {"key": "suc_khoe_truoc",
                                    "label": "Đánh giá sức khỏe (1-10) trước", "type": "number"},
                                {"key": "thoi_gian_xuat_truoc",
                                    "label": "Thời gian & trọng lượng xuất chuồng (trước)", "type": "text"},
                                {"key": "gia_ban",
                                    "label": "Giá bán (đồng/kg)", "type": "number"},
                                {"key": "thu_nhap",
                                    "label": "Thành tiền/thu nhập (đồng)", "type": "number"},
                            ],
                        }
                    ],
                },
